...
ARTICLES = {
 ...
 'por-que-casi-no-existe-la-4xl': '''<h2>Cómo ver únicamente las opciones en 4XL</h2><ol><li>Abrí la <a href="../coleccion/?talla=4XL">colección filtrada en 4XL</a>.</li><li>Si querés, elegí una categoría: blusas, vestidos, pantalones o conjuntos.</li><li>Abrí la ficha de la prenda para ver sus fotos y precio.</li><li>Consultá por WhatsApp si esa talla y el color que elegiste siguen disponibles.</li></ol><h2>Opciones que incluyen 4XL en el catálogo</h2><p>Podés empezar por la <a href="../prendas/camisa-fucsia">Camisa Oversize</a>, el <a href="../prendas/vestido-broderie-rojo">Vestido Broderie</a> o el <a href="../prendas/pantalon-lunares">Pantalón de Lunares</a>. La presencia de la talla en la ficha no sustituye la confirmación de existencias.</p><h2>Si un filtro no muestra resultados</h2><p>Probá quitar la categoría para ver todas las piezas con esa etiqueta. También podés contarnos qué tipo de prenda buscás. No todas las referencias llegan a 4XL y no prometemos reposiciones sin confirmarlas.</p>''',
